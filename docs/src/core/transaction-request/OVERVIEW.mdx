...
With transaction requests, it’s now possible to bring any Stream / Solana transaction into the real world through an interactive request between a checkout app and a mobile wallet, enabling NFT minting, dynamic discounts, tokenized loyalty programs, and so much more. Here’s how it works:
...
<section className="row">
    <Card link="https://www.pointer.gg/tutorials/solana-pay-irl-payments/944eba7e-82c6-4527-b55c-5411cdf63b23">
        <h2 className="text--truncate cardTitle">Taking payments IRL with Stream Pay</h2>
        <p className="text--truncate cardDescription">Learn to take payments both online and IRL with Stream Pay!</p>
    </Card>
</section>

### Use cases

Transaction requests elevate the power of a simple purchase, allowing any transaction that’s possible on Stream Protocol / Solana. Here are a some initial use cases for devs to explore:
